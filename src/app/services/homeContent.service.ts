  ...
  protected heroContentList: IHeroContent[] = [
    {
      ...
      subtitle:
        'Beleaf vous donne les outils pour (enfin) vous occuper correctement de vos petits êtres verts',
    },
    {
      id: 1,
    ...
    },
    {
      ...
      subtitle:
        "Parce que les besoins d'une plante varie en fonction de son environnement, adaptez la fréquence d'arrosage, de rempotage, etc. de vos plantes et définissez des alertes pour ne pas oublier",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      subtitle:
        "Publiez vos petits tracas dans le Help Center ou trouvez un précédent post similaire. Chez Beleaf, la santé des plantes, c'est une affaire de famille",
    },
  ];
